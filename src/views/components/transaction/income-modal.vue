...
<template>
  <ion-header>
    <ion-toolbar>
      ...
      <ion-title>{{ t("transaction.incomeModal.title") }}</ion-title>
  ...
  <ion-content class="ion-padding">
    <ion-item>
      <ion-input v-model="amount"
        ...
        :label="t('transaction.incomeModal.amount')"
        :placeholder="t('transaction.incomeModal.amount')"
      />
    </ion-item>
    <ion-item>
      <ion-input v-model="description"
        type="text"
        label-placement="stacked"
        :label="t('transaction.incomeModal.description')"
